Hospedagem: Utilizaremos uma aplicação chamada vercel.com (https://vercel.com/ - https://vercel.com/login). Ela aponta para um dos nossos repositórios do GitHub e realiza o Deploy (desdobramento), que é justamente a ação de disponibilizar o projeto para as pessoas.

Link sistema web: https://jogo-secreto-amber.vercel.app/
